...
const AddbloodForm = require('./views/add_blood_form')
const AgentDetailPage = require('./views/agent_detail')
const AgentList = require('./views/list_agents')
const bloodList = require('./views/list_blood')
const bloodDetail = require('./views/blood_detail')
...
document.addEventListener('DOMContentLoaded', () => {
  m.route(document.querySelector('#app'), '/', {
    ...
    '/create': resolve(AddbloodForm, true),
    '/blood/:recordId': resolve(bloodDetail),
    '/blood': resolve(bloodList),
