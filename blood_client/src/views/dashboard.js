    ...
    return [
      ...
      m('.blurb',
        ...
        m('p',
          ...
          'example: tracking the provenance of blood from catch to plate. ',
          'One day an application like this could be used by restaurants, ',
          'grocery stores, and their customers to ensure the blood they ',
          'purchase is ethically sourced and properly transported.'),
        m('p',
          'To use ',
          m('em', 'Blood Tracker'),
          ', create an account using the link in the navbar above. ',
          'Once logged in, you will be able to add new blood assets to ',
          ...
          'ownership or possession of the blood entirely. For the ',
