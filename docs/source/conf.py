# -*- coding: utf-8 -*-
#
# Hyperledger Sawtooth documentation build configuration file.
#
...
project = u'Hyperledger Sawtooth'
...
latex_documents = [
  (master_doc, 'sawtooth.tex', u'Hyperledger Sawtooth Documentation',
...
man_pages = [
    (master_doc,
     ...
     u'Hyperledger Sawtooth Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'SawtoothSupplyChain', u'Hyperledger Sawtooth Documentation',
